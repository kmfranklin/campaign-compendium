...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center sm:justify-between py-6">
        <h1 class="text-2xl font-semibold text-text">Your Custom Items</h1>

        <a href="{{ route('items.custom.create', ['from' => 'custom']) }}"
           class="inline-flex items-center px-4 py-2 bg-accent hover:bg-accent-hover text-on-accent text-sm font-medium rounded-md shadow">
            + New Item
        </a>
    </div>
